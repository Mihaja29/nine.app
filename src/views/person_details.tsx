...
export function PersonDetails({ person, onBack, onTalentClick }: PersonDetailsProps) {
  ...
  return (
    <div className="flex-1 bg-white overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] relative min-h-screen">
      {/* Cover Background */}
      <div 
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 px-6 pt-6 flex items-center justify-between z-10 text-white">
          ...
          <button 
            ...
            className="p-2 -mr-2 rounded-full hover:bg-black/20 transition-colors focus:outline-none backdrop-blur-sm bg-black/10 text-white"
          >
