        ...
        rightActions={
          ...
          >
            ...
            {unreadNotificationsCount > 0 && (
              <span className="absolute top-1 right-1 min-w-[18px] h-[18px] flex items-center justify-center bg-red-500 rounded-full text-sm font-bold text-white border-2 border-white px-1">
